...
/* IT PVR SGX 530 requires drmModeAddFB2() - the pixel format must be specified. */
...
/* gbm_bo_get_format() is required to obtain the pixel format for drmModeAddFB2() */
SDL_KMSDRM_LEGACY_SYM(uint32_t,gbm_bo_get_format,(struct gbm_bo *bo))
